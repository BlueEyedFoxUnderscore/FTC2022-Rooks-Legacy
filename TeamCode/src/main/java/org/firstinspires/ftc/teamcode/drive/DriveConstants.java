...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 1.027045567936138; // output (wheel) speed / input (motor) speed
     ...
     * empirically tuned.
     */
    public static double kV = 0.0117; //0.031; // 0.01425; //1.0 / rpmToVelocity(MAX_RPM);
    public static double kA = 0.00014;//0.0022;
    public static double kStatic = 0.05160;//0.053;
    /*
    ...
    // in = WR * 2 * pi * GR * ticks / TPR
    // in * TPR = WR * 2 * pi * GR * ticks
    // in * TPR / (WR * 2 * pi * GR) = ticks
